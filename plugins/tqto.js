...
`
    conn.sendButtonDoc(m.chat, tqto, wm,'menu','.menu', ftroli, { gifPlayback: true, contextInfo: { externalAdReply: {title: wm, body: date, sourceUrl: `https://youtu.be/PgCqyRXrQ80`, thumbnail: fs.readFileSync('./thumbnail.jpg') }}})
}
handler.help = ['tqto']
handler.tags = ['info']
